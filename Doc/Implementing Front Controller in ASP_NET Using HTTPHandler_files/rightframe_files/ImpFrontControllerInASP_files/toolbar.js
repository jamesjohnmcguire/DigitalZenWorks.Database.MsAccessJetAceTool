...
{  
    //  Begin MSDN WebMetrix QFE
    //  Friday, January 21, 2005 - seange
    //  QFE FOR MSDN METRIX FRAMESET
    //  This prevents the code from writing out multiple WebMetrix calls when content is within a frameset,
    //  as this cause redundant URLs to be tracked in WebMetrix, and also because of those multiple calls,
    //  affects the number of HTTP GETS, minimally helping rendering performance
    //  uncommenting this code results is 3 calls to http://c.microsoft.com/
    if (window.parent.frames != null )
    {   
        return;
    }
    //  End MSDN WebMetrix QFE
